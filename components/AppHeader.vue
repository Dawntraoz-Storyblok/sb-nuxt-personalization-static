    ...
    <nav class="" role="navigation">
      ...
      >
        ...
        <div class="w-full md:w-auto md:flex-grow md:flex md:items-center">
          <ul
            class="flex flex-col mt-4 -mx-4 pt-4 border-t md:flex-row md:items-center md:mx-0 md:mt-0 md:pt-0 md:mr-4 md:ml-auto lg:mr-8 md:border-0"
          >
            <li v-for="link in links" :key="`menu-header-nav-link-${link.url}`">
              <NuxtLink :to="link.url" class="block px-4 py-1 md:p-2 lg:px-8">
                {{ link.name }}
              </NuxtLink>
            </li>
          </ul>
...
const links = [
  ...
  { name: "Sportswear", url: "/catalog/sportswear" },
  { name: "Elegant Clothing", url: "/catalog/elegant" },
];
</script>
